...
Este es un Reproductor de Audio Web interactivo que simula una tornamesa física con una interfaz visual y animaciones realistas.  El proyecto está construido enteramente con HTML, CSS puro, y JavaScript vainilla.
